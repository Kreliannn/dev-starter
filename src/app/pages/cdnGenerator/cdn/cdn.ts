export const cdnData = [
    ...
    },
    {
        ...
        name : "Data tables",
        description : `
            DataTables is a powerful, feature-rich jQuery plugin for creating and managing dynamic, interactive, and highly customizable HTML tables. It simplifies adding advanced functionalities to tables, such as searching, sorting, pagination, and data handling.
        `,
    ...
    {
        img : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwq9UJ4ulGNCtyPkD44PpBg-lEny5djkPqUw&s",
        name : "Lefleat",
        description : `      
            Leaflet is a lightweight, open-source JavaScript library for creating interactive maps on web applications. It’s designed to be simple, efficient, and easy to integrate, making it an excellent choice for developers who want to incorporate maps into their projects.
        `,
    ...
    },
    {
        ...
        name : "Chart.js",
        description : `      
            Chart.js is a simple yet powerful open-source JavaScript library for creating interactive and customizable charts. It helps developers visualize data in an aesthetically pleasing and user-friendly way with minimal configuration.
        `,
