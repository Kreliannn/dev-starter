...
const backend = [
  { name : "express", command : "express @types/express", img : "https://img.icons8.com/color/512/express-js.png", documentation : "https://devdocs.io/express-getting-started/" },
  { name : "mongoose", command : "mongoose @types/mongoose", img : "https://4008838.fs1.hubspotusercontent-na1.net/hubfs/4008838/mogoose-logo.png", documentation : "https://mongoosejs.com/docs/" },
  { name : "passport", command : "passport @types/passport passport-local @types/passport-local", img : "https://cdn.glitch.me/project-avatar/0d184ee3-fd8d-4b94-acf4-b4e686e57375.png", documentation : "https://www.passportjs.org/docs/" },
  ...
  { name : "socket io", command : "socket.io @types/socket.io", img : "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Socket-io.svg/2048px-Socket-io.svg.png", documentation : "https://socket.io/docs/v4/" },
  ...
  { name : "open ai", command : "openai @types/openai", img : "https://cdn.worldvectorlogo.com/logos/openai-2.svg", documentation : "https://platform.openai.com/docs/quickstart" },
  { name : "cookie parser", command : "cookie-parser @types/cookie-parser", img : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIjCGnxYtwOu0H5owyaoSvbof60Y4OQt0vuQ&s", documentation : "https://expressjs.com/id/resources/middleware/cookie-parser.html" },
  { name : "express session", command : "express-session @types/express-session", img : "https://logovectordl.com/wp-content/uploads/2020/10/session-technologies-usesession-com-logo-vector.png", documentation : "https://www.npmjs.com/package/express-session" },
  ...
  { name : "JWT", command : "jsonwebtoken @types/jsonwebtoken", img : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5Pte0L4XLvNqEWXbkCXk_LDN6eSpcaDDLhQ&s", documentation : "https://www.geeksforgeeks.org/jwt-authentication-with-node-js/" },
  { name : "multer", command : "multer @types/multer", img : "https://miro.medium.com/v2/resize:fit:1400/1*QTZvtnHWanNxBQBynhtlIA.png", documentation : "https://www.npmjs.com/package/multer" },
]
