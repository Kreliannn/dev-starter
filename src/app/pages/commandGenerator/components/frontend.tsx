...
const frontend = [
  ...
  { check: false, name: "material ui", command: "@mui/material @emotion/react @emotion/styled", typescript: "", img: "https://pbs.twimg.com/profile_images/1798056830041788417/HIapkjDx_400x400.jpg", documentation: "https://mui.com/material-ui/getting-started/" },
  { check: false, name: "zustand", command: "zustand", typescript: "", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpHj4UwTW4ANSlNjzQOiiOqfDa6kal9RpF0A&s", documentation: "https://zustand.docs.pmnd.rs/getting-started/introduction" },
  { check: false, name: "react query", command: "@tanstack/react-query", typescript: "", img: "https://miro.medium.com/v2/resize:fit:1400/1*elhu-42TzQEdsFjKDbQhhA.png", documentation: "https://tanstack.com/query/latest/docs/framework/react/overview" },
  { check: false, name: "axios", command: "axios", typescript: "", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqynh9tnAbPVgXfQrvD8vLbktM7S9PPEfeuA&s", documentation: "https://axios-http.com/docs/intro" },
  { check: false, name: "sweet alert 2", command: "sweetalert2", typescript: "", img: "https://rohit-chouhan.gallerycdn.vsassets.io/extensions/rohit-chouhan/sweetalert2-snippet/1.1.2/1625627316335/Microsoft.VisualStudio.Services.Icons.Default", documentation: "https://sweetalert2.github.io/" },
  { check: false, name: "MUI icons", command: "@mui/icons-material", typescript: "", img: "https://blogs.purecode.ai/blogs/wp-content/uploads/2023/10/a6aca62b-5471-4921-ab9e-49f26a17b662.png", documentation: "https://mui.com/material-ui/material-icons/?srsltid=AfmBOopKB5oM361ukRLTjKvV1qYDn9hSraJ9yP9rpWUnkWopogmlczvc" },
  { check: false, name: "redux", command: "redux", typescript: "", img: "https://static-00.iconduck.com/assets.00/redux-icon-2048x1945-ahvhunxp.png", documentation: "https://redux.js.org/introduction/getting-started" },
  ...
  { check: false, name: "react router", command: "react-router-dom", typescript: "", img: "https://static-00.iconduck.com/assets.00/react-router-icon-512x279-zswz065s.png", documentation: "https://reactrouter.com/home" },
  { check: false, name: "framer motion", command: "framer-motion", typescript: "", img: "https://cdn.worldvectorlogo.com/logos/framer-motion.svg", documentation: "https://motion.dev/docs/quick-start" },
  { check: false, name: "Gsap", command: "gsap", typescript: "", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3vteG2DudlxILcIB8idhgX49HFuCk4_nEtQ&s", documentation: "https://gsap.com/cheatsheet" },
];
