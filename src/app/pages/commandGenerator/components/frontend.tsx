...
let backend = [
  ...
  { name : "react query", command : "@tanstack/react-query", img : "https://miro.medium.com/v2/resize:fit:1400/1*elhu-42TzQEdsFjKDbQhhA.png", documentation : "https://tanstack.com/query/latest/docs/framework/react/overview" },
  ...
  { name : "sweet alert 2", command : "sweetalert2", img : "https://rohit-chouhan.gallerycdn.vsassets.io/extensions/rohit-chouhan/sweetalert2-snippet/1.1.2/1625627316335/Microsoft.VisualStudio.Services.Icons.Default", documentation : "https://sweetalert2.github.io/" },
  { name : "MUI icons", command : "@mui/icons-material", img : "https://blogs.purecode.ai/blogs/wp-content/uploads/2023/10/a6aca62b-5471-4921-ab9e-49f26a17b662.png", documentation : "https://mui.com/material-ui/material-icons/?srsltid=AfmBOopKB5oM361ukRLTjKvV1qYDn9hSraJ9yP9rpWUnkWopogmlczvc" },
  { name : "redux", command : "redux", img : "https://static-00.iconduck.com/assets.00/redux-icon-2048x1945-ahvhunxp.png", documentation : "https://redux.js.org/introduction/getting-started" },
  ...
  { name : "react router", command : "react-router-dom", img : "https://static-00.iconduck.com/assets.00/react-router-icon-512x279-zswz065s.png", documentation : "https://reactrouter.com/home" },
  { name : "framer motion", command : "framer-motion", img : "https://cdn.worldvectorlogo.com/logos/framer-motion.svg", documentation : "https://motion.dev/docs/quick-start" },
